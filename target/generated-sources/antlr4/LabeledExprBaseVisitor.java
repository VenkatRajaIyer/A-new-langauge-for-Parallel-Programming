...
public class LabeledExprBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements LabeledExprVisitor<T> {
	@Override public T visitParallel(LabeledExprParser.ParallelContext ctx) { return visitChildren(ctx); }
	...
	@Override public T visitTasks(LabeledExprParser.TasksContext ctx) { return visitChildren(ctx); }
	...
	@Override public T visitCritSec(LabeledExprParser.CritSecContext ctx) { return visitChildren(ctx); }
